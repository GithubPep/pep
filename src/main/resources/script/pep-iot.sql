...
(
    ...
    updateTime timestamp   null comment '最后修改时间',
...
(
    ...
    dayBeginTime       varchar(64) null comment '自定义开始时间',
    dayEndTime         varchar(64) null comment '自定义结束时间',
